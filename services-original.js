sikatApp.service("pmkpService", function($http) {
  var dailyNames = {
    igd: [
      ...
      "Jumlah seluruh pasien di hari tersebut",
      "Jumlah waktu yang diperlukan sejak kedatangan pasien (kegawatan hipertensi) sampai mendapat pelayanan dokter",
    ...
    rawatJalan: [
      ...
      "Jumlah assessment awal pasien Hipertensi yang diisi lengkap",
      "Jumlah pasien Hipertensi di hari tersebut",
      "Jumlah pasien hipertensi stabil yang diikutkan PRB di hari tersebut",
      "Jumlah seluruh pasien hipertensi stabil di hari tersebut"
    ],
    rawatInap: [
      "Jumlah visite dokter spesialis yang terlaksana sesuai ketentuan", //1
      "Jumlah visite dokter spesialis di hari tersebut (sesuai jadwal)",
      "Angka kejadian infeksi nosokomial yang terjadi di rawat inap", //2
      "Jumlah pasien yang dirawat di rawat inap",
      "Jumlah kejadian kematian pasien rawat inap > 48 jam ", //3
      "Jumlah seluruh pasien dalam satu bulan",
      "Jumlah pasien pulang paksa ", // 4
      "Jumlah seluruh pasien rawat inap dalam 1 bulan",
      "Jumlah kejadian reaksi transfusi", //5
      "Jumlah seluruh pasien rawat inap yang mendapat trasfusi dalam 1 bulan",
      "Jumlah pasien baru yang masuk rawat inap dengan assessmen medis dan keperawatan lengkap <24 jam ", // 6
      "Jumlah seluruh pasien baru yang masuk rawat inap ",
      "Jumlah pasien baru yang masuk rawat inap dengan assessmen medis Hipertensi dan keperawatan lengkap <24 jam ", //7
      "Jumlah seluruh pasien baru yang masuk rawat inap dengan diagnosa Hipertensi",
      "Jumlah pasien baru diganosis Hipertensi  dengan assessmen medis dan keperawatan lengkap <24 jam ", // 8
      "Jumlah seluruh pasien baru diagnosis Hipertensiyang masuk rawat inap ",
      "Jumlah pasien rawat inap yang dilakukan identifikasi dengan tepat", // 9
      "Jumlah seluruh  Pasien Rawat Inap "
      ],
    kamarOperasi: [
      "Jumlah kumulatif waktu tunggu operasi yang terencana ", // 1
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Jumlah kejadian kematian di meja operasi", // 2
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Kejadian operasi salah sisi", // 3
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Kejadian operasi salah orang", // 4
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Kejadian operasi salah jenis tindakan operasi", // 5
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Kejadian tertinggal benda asing", // 6
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Jumlah pasien yang mengalami komplikasi anastesi", // 7
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Jumlah pasien yang jadwal operasi nya berubah", // 8
      "Jumlah pasien yang dioperasi di hari tersebut",
      "Jumlah lembar surgery safety checlist yang ditulis lengkap ", // 9
      "Jumlah pasien yang dioperasi di hari tersebut"
    ],
    perinatologi: [
    ...
    hcu: [
      ...
      "Jumlah seluruh pasien rawat inap dalam 1 bulan",
      "Jumlah pasien yang kembali ke perawatan dengan kasus yang sama < 72 jam",
    ...
    kamarBersalin: [
      ...
      "Jumlah pasien BBL yang dilakukan IMD sesuai ketentuan",
      "Jumlah pasien BBL di hari tersebut",
      "Jumlah pasien kamar bersalin yang dilakukan identifikasi dengan tepat",
      "Jumlah seluruh  Pasien kamar bersalin "
    ],
    radiologi: [
    ...
    farmasi: [
      ...
      "Jumlah resep pasien Hipertensi yang  yang sesuai formularium ",
      "Jumlah resep pasien Hipertensi yang disurvey",
    ...
    kasir: [
      ...
      "Jumlah permintaan pembukaan billing pasien yang sudah ditutup",
    ...
    loketPendaftaran: [
      "jumlah pasien yang dilayani > 10 menit",
      "jumlah pasien yang didaftarkan di hari tersebut",
    ...
    timKprs: [
      "Jumlah pasien yang dilakukan identifikasi dengan tepat", // 1
      "Jumlah seluruh Pasien",
      "Konsultasi SBAR yang ditulis lengkap dan di lakukan proses konfirmasi dengan tepat dan benar", // 2
      "Jumlah seluruh pasien yang dilakukan SBAR",
      "Jumlah hasil laboratorium kritis pasien yang dilaporkan < 30 menit", // 3
      "Jumlah hasil laboratorium kritis pasien di hari tersebut",
      "Jumlah obat yang diberikan tepat sesuai ketentuan", // 4
      "Jumlah seluruh pemberian obat high alert yang dipantau",
      "Seluruh lembar surgery safety checlist yang ditulis lengkap", // 5
      "Seluruh pasien yang mendapat pembedahan di hari tersebut",
	  "Jumlah seluruh tenaga medis yang melakukan kebersihan tangan dengan benar", // 6
      "Jumlah seluruh tenaga medis yang diamati",
	  "Jumlah pasien yang dilakukan tindakan pengelolaan resiko jatuh dengan tepat", // 7
      "jumlah pasien Rawat inap dalam 1 bulan",
      "Jumlah kejadian pasien jatuh", // 8
      "Jumlah seluruh pasien"
    ],
    komiteMedis: [],
    komiteKeperawatan: [],
  ...
  var monthlyNames = {
    igd: [
      ...
      "Waktu tanggap Penanganan kegawatdaruratan pasien hipertensi di IGD",
    ...
    rawatJalan: [
      ...
      "Kelengkapan assessment awal pasien  Hipertensi di rawat jalan",
      "Pasien hipertensi stabil yang mengikuti program rujuk balik" 
    ],
    rawatInap: [
      "Jam visite dokter spesialis", // 1
      "Angka kejadian infeksi nosokomial", // 2
      "Tidak adanya kejadian pasien jatuh yang berakibat kecacatan atau kematian", // 3
      "Kematian pasien > 48 Jam", // 4
      "Adanya pasien jatuh yang berakibat kecatatan/kematianKejadian pulang paksa", // 5
      "Kepuasaan pelanggan Rawat Inap", // 6
      "Pemenuhan kebutuhan darah bagi setiap pelayanan transfusi", // 7
      "Kejadian reaksi transfusi", // 8
      "Kelengkapan pengisian asessment awal < 24 jam sesudah masuk Rumah Sakit", // 9
      "Kelengkapan asessment awal medis dan keperawatan pasien Hipertensi di Rawat Inap < 24 Jam", // 10
      "ketepatan identifikasi pasien di rawat inap", // 11
      "Identifikasi perburukan pasien hipertensi di rawat inap" // 12
    ],
    kamarOperasi: [
    ...
    hcu: [
      ...
      "kejadian pulang paksa",
      "Rata-rata pasien yang kembali ke perawatan HCU dengan kasus yang sama <72 jam",
    ...
    kamarBersalin: [
      ...
      "Kepuasan Pelanggan",
      "Angka kejadian pasien jatuh di kamar bersalin",
      "Pelaksanaan IMD",
      "Ketepatan identifikasi di kamar bersalin"
    ],
    radiologi: [
    ...
    farmasi: [
      ...
      "Kepuasan pelanggan",
      "Kekosongan obat Hipertensi",
      "Kepatuhan Penggunaan obat Hipertensi sesuai formularium Rumah Sakit",
    ...
    gizi: [
      ...
      "Kepuasan pelanggan",
      "Jumlah pasien hipertensi di rawat jalan yang mendapat konseling gizi minimal 1x/3 bulan"
    ],
    rekamMedis: [
    ...
    cssdLinen: [
      "keberhasilan proses sterilisasi proses sterilisasi"
    ],
	 Linen: [
    ...
    kasir: [
      ...
      "Tidak padanya permintaan pembukaan billing pasien bpjs rawat jalan",
      "Tidak adanya pasien rawat jalan (pembayaran umum) yang tidak membayar tagihan tindakan"
    ],
    loketPendaftaran: [
      "Waktu pelayanan pendaftaran di loket  > 10 menit",
    ...
    timKprs: [
      "Ketepatan identifikasi pasien di rumah sakit", // 1
      "Konsultasi SBAR yang ditulis lengkap dan di lakukan proses konfirmasi dengan tepat dan benar", // 2
      "Waktu lapor hasil kritis laboratorium pasien DM", // 3
      "Ketepatan pemberian obat high alert sesuai prosedur", // 4
      "Kelengkapan pengisian surgery safety checklist pasien operasi", // 5
      "Kepatuhan kebersihan tangan", // 6
      "Kepatuhan pengelolaan pasien resiko jatuh sesuai prosedur di rawat inap", // 7
      "Kejadian pasien jatuh", // 8
      "Ketepatan identifikasi pasien hipertensi di rawat inap" // 9
    ],
    ...
    komiteKeperawatan: [
      ...
      "Kepatuhan pelaksanaan Asuhan Keperawatan Hipertensi di rawat inap"
    ],
    komiteNakesLain: [
      "Kepatuhan pelaksanaan asuhan gizi pasien Hipertensi di rawat inap",
      "Kepatuhan pelaksanaan asuhan kefarmasian pasien Hipertensi di rawat inap"
    ],
    timPkrs: [
    ...
    manajemenKepegawaian: [
      "Kelengkapan Laporan Akuntabilitas Kinerja", // 1
      "Cost Recovery Rate", // 2
      "Ketepatan Waktu Penyusunan Laporan Keuangan", // 3
      "Ketepatan Waktu Pemberian Gaji dan tunjangan pegawai non PNS Sesuai Kesepakatan Waktu", // 4
      "Ketepatan Waktu Pengusulan Kenaikan Pangkat", // 5
      "Pelatihan Staf Minimal 20 jam/tahun", // 6
      "Daftar Urut Kepangkatan", // 7
      "Kepatuhan absenteisme pegawai   ≤ 185 menit per bulan " //8
    ]
  };
  var monthlyTarget = {
    igd: [
    ...
    k3rs: ["100%", "100%", "100%"],
    kasir: ["≤ 120 Menit", "100%", "100%"],
    loketPendaftaran: ["0%", "100%"],
  ...
  var monthlyDisable = {
    ...
    kamarBersalin: [
      ...
      [5, "numerator", "denumerator", "hasil"],
      [8, "numerator", "denumerator", "hasil"],
      [14, "numerator", "denumerator", "hasil"]
    ],
    radiologi: [
      [1, "numerator", "denumerator", "hasil"],
      [3, "numerator", "denumerator", "hasil"],
